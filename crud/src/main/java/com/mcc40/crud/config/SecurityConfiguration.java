...
import com.mcc40.crud.services.ImplAuthenticationProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private ImplAuthenticationProvider authProvider;
...
//                .and().formLogin();
        http.csrf().disable()
                ...
                .antMatchers("/api/locations/**").hasAnyRole("user", "admin")
                .antMatchers("/api/locations/**").hasAnyRole("user", "admin")
                .antMatchers("/**").hasRole("admin")
